...
import { Activity, CheckCircle, XCircle, Clock, ArrowRight, Database, Snowflake } from "lucide-react";
    ...
    <div className="p-6 lg:p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <MetricCard
          ...
          icon={XCircle}
          variant="destructive"
          trend={{ value: "1 less than yesterday", positive: true }}
        />
        <MetricCard
          title="Avg Latency"
          value="6.2m"
          subtitle="Batch pipelines"
          icon={Clock}
          variant="default"
          trend={{ value: "8% faster", positive: true }}
        />
      </div>
